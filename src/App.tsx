...
function App() {
  ...
  return (
    <main className="relative bg-black w-full overflow-hidden">
      ...
      <section id="contact" className="py-12 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 pb-6 flex flex-col items-center justify-center relative overflow-hidden bg-white/[0.01] [contain:paint]">
